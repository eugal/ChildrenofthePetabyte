...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("assets/dataship.png", nme.NME_assets_dataship_png);
			type.set ("assets/dataship.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/dataship2.png", nme.NME_assets_dataship2_png);
			type.set ("assets/dataship2.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			className.set ("assets/wall.gif", nme.NME_assets_wall_gif);
			type.set ("assets/wall.gif", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/wallA1.png", nme.NME_assets_walla1_png);
			type.set ("assets/wallA1.png", Reflect.field (AssetType, "image".toUpperCase ()));
...
class NME_assets_dataship_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_dataship2_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
...
class NME_assets_wall_gif extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_walla1_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
